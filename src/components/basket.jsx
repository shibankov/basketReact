                                    ...
                                    basket.map((item) =>(
                                        <div className="basket-section__col">
                                            <div key={item.id} className="card-basket">
                                                <button className="card-basket__close" type="button" onClick={()=>delBasket(item.id)}>
                                                ...
                                                <div className="card-basket__row">
                                                    <div className="card-basket__col">
                                                        <div className="card-basket__count">
                                                            <button className="btn-circle" type="button" onClick={()=>minusOneBasket(item.id)}>
                                                                <svg width="18" height="2" viewBox="0 0 18 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path d="M0.788879 0H17.2V2H0.788879V0Z" fill="white"/>
                                                                </svg>
                                                            </button>
                                                            <div className="card-basket__value">{item.count}</div>
                                                            <button className="btn-circle" type="button" onClick={()=>plusOneBasket(item.id)}>
